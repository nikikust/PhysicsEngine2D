...
{
public:
	CollisionSolver(DataStorage& data_storage);
	...
	void resolve_collision_simple(const CollisionInfo& collision, std::shared_ptr<Shape> shape_A, std::shared_ptr<Shape> shape_B);
